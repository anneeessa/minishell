...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/16 19:05:17 by anmohamm          #+#    #+#             */
/*   Updated: 2024/02/16 19:05:17 by anmohamm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	expand(t_data **data)
{
	...
	{
		expanded_str = check_expansion((*data)->copy_input, data);
		free((*data)->copy_input);
		(*data)->copy_input = expanded_str;
	}
